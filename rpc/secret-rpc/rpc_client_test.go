...
func TestGetValInfo(t *testing.T) {
	grpcConn, err := rpc.InitChainRpcCli("https://secret-grpc.lavenderfive.com:443")
	if err != nil {
	...
	monitorObj = append(monitorObj, "secretvaloper1utjz56dymhnu97jdzy8rhpwp9y97pt7duaa5ut")
