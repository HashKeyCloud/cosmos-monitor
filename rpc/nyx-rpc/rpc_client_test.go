...
func TestGetValInfo(t *testing.T) {
	grpcConn, err := rpc.InitChainRpcCli("nym-grpc.polkachu.com:15390")
	if err != nil {
		logger.Error("Failed to create nyx gRPC client, err:", err)
	}
	...
	monitorObj = append(monitorObj, "nvaloper1e22wh85arrkpe6derct4l5r4gp3awvase24pf6")
